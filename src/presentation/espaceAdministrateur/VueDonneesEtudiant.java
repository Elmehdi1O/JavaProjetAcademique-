...
public class VueDonneesEtudiant extends JFrame {
	...
	public void init() throws ClassNotFoundException {
		...
		modele = new ModeleVueDonneesEtudiant(model, cneText1, nomText, prenomText, emailText, passwordText,
				filierlist);
	...
	public void dessin() {
		...
		/*
		 * panel1.setLayout(new GridLayout(6,2)); panel1.add(cne); panel1.add(cneText);
		 * panel1.add(nom); panel1.add(nomText); panel1.add(prenom);
		 * panel1.add(prenomText); panel1.add(email); panel1.add(emailText);
		 * panel1.add(password); panel1.add(passwordText); panel1.add(filier);
		 * panel1.add(filierlist); panel1.setPreferredSize(new Dimension(200,30));
		 */
	...
	public void action() {
		ajouter.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (modele.add()) {
					JOptionPane.showMessageDialog(null, "1 etudiant est ajouter ", "Message",
							JOptionPane.INFORMATION_MESSAGE);
					modele.reset();
				} else {
					JOptionPane.showMessageDialog(null, "les donnees sont incorrect!", "Erreur",
		...
		recherche2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (etudiant != null) {
					int choix = JOptionPane.showConfirmDialog(null, "Voullez-vous vraiment supprimer ce etudiant? ",
							"Supprimer...", JOptionPane.YES_NO_CANCEL_OPTION);
					if (choix == 0) {
